...
<form action="<?= base_url('admin/transactions')?>/<?= $edit ? 'edit/'.esc($id): 'add'?>" method="post" enctype="multipart/form-data">
...
<div class="card card-light">
    <div class="card-body">
        ...
        <div class="form-group"> <!-- Amount Paid -->
            ...
            <select class="form-control select2 <?=isset($errors['payment_id']) ? 'is-invalid': ''?>" id="payment_id" name="payment_id">
              <option value="">Select...</option>
